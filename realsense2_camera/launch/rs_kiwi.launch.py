...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'confidence_qos',               'default': 'DEFAULT', 'description': 'QoS profile name'},    
                           {'name': 'depth_qos',                    'default': 'DEFAULT', 'description': 'QoS profile name'},    
                           {'name': 'fisheye_qos',                  'default': 'DEFAULT', 'description': 'QoS profile name'},    
                           {'name': 'infra_qos',                    'default': 'DEFAULT', 'description': 'QoS profile name'},   
                           {'name': 'pointcloud_qos',               'default': 'DEFAULT', 'description': 'QoS profile name'}, 
